...
function updateMap(underCategory){
	...
	if(underCategory == "Snømåking"){
		underCategory = "Snomaking";
	}
	if(underCategory == "Gå tur med hunden"){
		underCategory = "Ga tur med hunden"
	}
	if(underCategory == "Møbelsammensetting"){
		underCategory = "Mobelsammensetting";
	}
	removeMapMarkers();
	emptyWorkersList();
	
	var mapHeader = document.getElementById("changingUnderCat");
	mapHeader.innerHTML = "i underkategorien "+chosenUnderCat;
